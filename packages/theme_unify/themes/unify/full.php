...
<head>
    ...
    <link rel="stylesheet" href="<?=$view->getThemePath()?>/plugins/bootstrap/css/bootstrap.min.css">
    <link rel="stylesheet" href="<?=$view->getThemePath()?>/css/style.css">

    <!-- CSS Header and Footer -->
    <link rel="stylesheet" href="<?=$view->getThemePath()?>/css/headers/header-default.css">
    <link rel="stylesheet" href="<?=$view->getThemePath()?>/css/footers/footer-v2.css">

    <!-- CSS Implementing Plugins -->
    <link rel="stylesheet" href="<?=$view->getThemePath()?>/plugins/animate.css">
    <link rel="stylesheet" href="<?=$view->getThemePath()?>/plugins/line-icons/line-icons.css">

    <!-- CSS Customization -->
    <link href="<?=$view->getStylesheet('custom.less')?>" rel='stylesheet' type='text/css'>
...
<div class="wrapper">
    ...
    <div class="header header-sticky">
        <div class="container">
            <!-- Logo -->
            <a class="logo" href="<?=$view->getThemePath()?>/index.html">
                <img src="<?=$view->getThemePath()?>/img/logo1-default.png" alt="Logo">
            </a>
            <!-- End Logo -->
            ...
            <div class="topbar">
                <ul class="loginbar pull-right">
                    ...
                    <li><a href="#">Help</a></li>
                    <li class="topbar-devider"></li>
                    <li><a href="/conc/index.php/login">Login</a></li>
                </ul>
            </div>
            <!-- End Topbar -->
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="dropdown-submenu active">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li class="active"><a href="feature_footer_v2.html#footer-v2">Footer v2</a></li>
    ...
    <!--=== Content ===-->
        <?
        $navHeaderArea = new GlobalArea('Navigation Header');
        $navHeaderArea->display($c);

        $mainArea = new Area('Main');
        $mainArea->enableGridContainer();
        $mainArea->display($c);
        ?>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-md-3 md-margin-bottom-40">
                        <a href="<?=$view->getThemePath()?>/index.html"><img id="logo-footer" class="footer-logo" src="<?=$view->getThemePath()?>/img/logo1-default.png" alt=""></a>
...
<script type="text/javascript" src="<?=$view->getThemePath()?>/plugins/jquery/jquery-migrate.min.js"></script>
<script type="text/javascript" src="<?=$view->getThemePath()?>/plugins/bootstrap/js/bootstrap.min.js"></script>
<!-- JS Implementing Plugins -->
<script type="text/javascript" src="<?=$view->getThemePath()?>/plugins/back-to-top.js"></script>
<script type="text/javascript" src="<?=$view->getThemePath()?>/plugins/smoothScroll.js"></script>
<script type="text/javascript" src="<?=$view->getThemePath()?>/plugins/jquery.parallax.js"></script>
<!-- JS Customization -->
<script type="text/javascript" src="<?=$view->getThemePath()?>/js/custom.js"></script>
<!-- JS Page Level -->
